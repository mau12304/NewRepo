...
namespace Proyecto_MySQL_OOP.ClasesDb
{
    internal class TbProductos
    {
        ...
        public void insertarProductos(int id_producto, TextBox Nombre, TextBox Color, TextBox Talla, int Genero, int Tipo, int Modelo,TextBox Precio,TextBox comentarios)
        {
            try
            {
                ...
                "values ('" + id_producto + "','" + Nombre.Text + "','" + Color.Text + "','" 
        ...
        public void modificarProductos(int id_producto, TextBox Nombre, TextBox Color, TextBox Talla, int Genero, int Tipo, int Modelo, TextBox Precio, TextBox comentarios)
        {
            try
            {
                ConexionDb objetoConexion = new ConexionDb();
                ...
                "', id_tipo='" + Tipo + "', id_modelo='" + Modelo + "', Precio='" + Precio.Text + "', comentarios='" + comentarios.Text + "' where id_producto ='" + id_producto + "';";
